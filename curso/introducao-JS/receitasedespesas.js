...
// A função calculaSaldo deve utilizar a função somaNumeros para calcular a soma
//de receitas e despesas e no fim retornar o saldo do usuário, ou seja receitas - despesas.
